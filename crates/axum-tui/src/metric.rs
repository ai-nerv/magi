...
//!
//! Rows, budgets, fractions and rates, all of them settable by the names below from `axum.ui` in
...
//! axum.ui.preview_lines = 20
//! axum.ui.scan_speed    = 2
//! ```
//!
...
macro_rules! metrics {
    ($($name:ident: $kind:ty = $default:literal, $floor:literal, $doc:literal;)*) => {
        ...
        impl Metrics {
            /// Every name `axum.ui` recognises as a number.
