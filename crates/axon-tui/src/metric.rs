...
//!
//! Rows, budgets, fractions and rates, all of them settable by the names below from `axon.ui` in
...
//! axon.ui.preview_lines = 20
//! axon.ui.scan_speed    = 2
//! ```
//!
...
macro_rules! metrics {
    ($($name:ident: $kind:ty = $default:literal, $floor:literal, $doc:literal;)*) => {
        ...
        impl Metrics {
            /// Every name `axon.ui` recognises as a number.
...
metrics! {
    ...
    beacon_ms: u64 = 1_000, 1, "One cycle of the four-cell display under the box.";
