...
//!
//! OSC 52, because it is the only clipboard that works everywhere axon runs. A local one — X11,
//! Wayland — is the wrong shape twice over: axon is often on the far side of ssh, where the
