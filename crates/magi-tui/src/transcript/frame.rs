...
/// Where a filled row starts, and how wide the colour is. One place, because the fill, the blank
/// rows that breathe around it and the seam through it all have to end in the same column.
